...
splashLines = [
    ...
    "blehhh",
    "This is fine...",
    "can you guys recommend me splashes",
    ...
    "Trans Soda!!",
    "Bisexual Pie!!",
    "I swear, these splashes are getting ridiculous.",
    ...
    "don't listen to the next splash!",
    "Absolute Cinema",
    "Check out BFDI!",
    ...
    "why are you looking at splashes anyway?",
    "*paws at you*",
    ...
    `FNUKIN BNUUY`,
    `Hit refresh one more time, I DARE YOU`,
    `Bunny Bunny Bunny Bunny Bunny`,
    `Make sure to water your plant friends!`,
    `ill finish writing this later`,
    `NOT Kurzgesagt!`,
    `Wawa`,
    `What are splashes?`,
